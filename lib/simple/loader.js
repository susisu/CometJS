...
prelude["_!!_"] = new Value(DataType.FUNCTION, function (_args) {
    ...
    if (_args[0].data[_args[1].data] !== undefined) {
...
function parse(script) {
    ...
    var literal = lq.getPosition.bind(function (pos) {
    ...
    var operator = lq.getPosition.bind(function (pos) {
        return tokenParser.brackets(tokenParser.operator).bind(function (name) {
